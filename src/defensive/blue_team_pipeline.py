...
import hashlib
from .threat_detectors import (
    run_all_detectors, ThreatLevel
)
...
class ThreatEvent:
    ...
    original_model_prediction: Optional[Dict] = None
...
class BlueTeamPipeline:
    ...
    def detect_threats(self, text: str, model_output: Optional[Dict] = None) -> Optional[ThreatEvent]:
        """
